                ...
                return Expanded(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: index <= _currentStep ? Colors.red[600] : Colors.grey[300],
          ...
          if (_isCodeSent) ...[
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: _isEmailVerified ? Colors.green[600] : Colors.red[600],
                  foregroundColor: Colors.white,
                  padding: const EdgeInsets.symmetric(vertical: 16),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Review cards
          _buildReviewCard('Name', _nameController.text),
          const SizedBox(height: 16),
          _buildReviewCard('Username', _usernameController.text),
          const SizedBox(height: 16),
          _buildReviewCard('University', _selectedUniversity),
          const SizedBox(height: 16),
          _buildReviewCard('Major', _selectedMajor),
          const SizedBox(height: 16),
          _buildReviewCard('Year', _selectedYear),
          const SizedBox(height: 16),
          _buildReviewCard('Nationality', _selectedNationality),
          const SizedBox(height: 16),
          _buildReviewCard('Email', _emailController.text),
          const SizedBox(height: 16),
          _buildReviewCard('Email Status', _isEmailVerified ? 'Verified ✓' : 'Not Verified'),
          const SizedBox(height: 16),
          _buildReviewCard('Terms & Conditions', _agreeToTerms ? 'Agreed ✓' : 'Not Agreed'),
        ],
      ),
    );
  }
