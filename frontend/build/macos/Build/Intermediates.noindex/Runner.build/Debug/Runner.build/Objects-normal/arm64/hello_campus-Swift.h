...
#ifndef HELLO_CAMPUS_SWIFT_H
#define HELLO_CAMPUS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="hello_campus",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC12hello_campus11AppDelegate")
...
SWIFT_CLASS("_TtC12hello_campus17MainFlutterWindow")
